...
const requestedUiLanguage=new URLSearchParams(location.search).get('lang');
const state = { token: sessionStorage.getItem('salonToken'), user: null, customers: [], templates: [], scan: null, image: '', images: [], partImages: { new: '', progress: '' }, treatmentType: 'フット', chartGender: 'common', chartLanguage: 'ja', uiLanguage: requestedUiLanguage==='en'||requestedUiLanguage==='ja'?requestedUiLanguage:localStorage.getItem('salonUiLanguage') === 'en' ? 'en' : 'ja', workflowStage: 'new', selectedTemplate: null, selectedCustomerId: '', sheetValidationToken: 0 };
const englishText = new Map(Object.entries({
  '紙のカルテを、次の接客につながる記録へ。':'Turn paper consultation sheets into better client care.',
  '✦ AI手書きカルテ読取':'✦ AI handwriting OCR','✦ AIカメラ':'✦ AI camera','✦ AIサマリ生成':'✦ AI summary generation','✦ お客様ごとの施術履歴':'✦ Treatment history by client','✦ アレルギー・注意事項を自動通知':'✦ Automatic allergy and caution alerts',
  'おかえりなさい':'Welcome back','店舗アカウントにログインしてください':'Sign in to your salon account','ユーザーID':'User ID','パスワード':'Password','店舗を選択':'Select salon','ログイン':'Sign in','管理者から発行されたアカウントをご利用ください':'Use the account issued by your administrator',
  'ログアウト':'Sign out','稼働状況':'System status','契約会社・店舗管理':'Companies and salons','オーナー':'Owner','スタッフ':'Staff','システム管理者':'System administrator',
  '契約会社名':'Company','店舗名':'Salon','登録お客様':'Registered clients','注意事項あり':'Clients with cautions','お客様履歴':'Client history','最近の施術記録':'Recent treatments','すべて見る →':'View all →','施術履歴':'Treatment history','確認済み':'Checked','まだ記録がありません':'No records yet',
  'AIカルテ':'AI Chart','お客様を選ぶ':'Select client','カメラ':'Camera','ファイルを開く':'Open files','OCR':'OCR','保存':'Save','閉じる':'Close','キャンセル':'Cancel','撮影':'Capture','カルテ撮影':'Sheet capture','A4用紙を枠内に合わせてください':'Align the A4 sheet inside the frame',
  '選択した画像・OCR記入欄':'Selected sheet and OCR fields','1枚目':'Page 1','2枚目':'Page 2','お名前':'Name','メール':'Email','ご住所':'Address','生年月日':'Date of birth','ご職業':'Occupation','生活習慣':'Lifestyle','同意日':'Consent date','同意者氏名':'Signature','施術同意日':'Treatment consent date','使用化粧品':'Products used','デイリーケア方法等':'Daily care','その他':'Other notes',
  '足の状態':'Foot condition','フットケアの経験':'Foot care history','肌の色調':'Skin tone','角質の状態':'Keratin condition','お肌の状態・お手入れ方法':'Skin condition and routine','脱毛の経験':'Hair removal history','ワックス脱毛施術部位':'Waxing areas','VIOデザイン':'VIO design',
  'アカウント管理':'Account management','施術者アカウントを作成':'Create practitioner account','施術者名':'Practitioner name','アカウント名':'Account ID','初期パスワード':'Initial password','アカウントを作成':'Create account','店舗アカウント':'Salon accounts','削除':'Delete'
}));
Object.entries({
  '日本語':'Japanese','英語':'English','男性':'Male','女性':'Female','男性用':'Male','女性用':'Female','男女共通':'Unisex','未設定':'Not set','未登録':'Not registered','不明':'Unknown','件':' records','人':' clients','枚':' pages','月':' month','時間':' hours','分':' min','日':' days',
  'AI待機中':'AI ready','AI作動中':'AI working','読み込み中…':'Loading...','読み込み中':'Loading...','再読み込み':'Reload','処理に失敗しました':'Operation failed','サーバーに接続できません。通信環境を確認して再度お試しください':'Cannot connect to the server. Check your connection and try again.','サーバーが一時的に応答できません。少し待って再度お試しください':'The server is temporarily unavailable. Please try again shortly.','サーバーから不正な応答を受信しました。再度お試しください':'The server returned an invalid response. Please try again.',
  'システム全体':'All salons','カルテ':'Consultation sheet','AIカルテ':'AI Chart','カルテを読み取る':'Scan consultation sheet','カルテ画像':'Consultation sheet image','カルテ画像を選択してください':'Select a consultation sheet image','カルテフォーム':'Consultation sheet form','画像を選択':'Select image','サンプルで試す':'Try sample','AI OCRを実行':'Run AI OCR','読取結果の確認':'Review OCR results','保存前に修正できます':'Editable before saving','左側で画像を選び':'Select an image on the left','AI OCRを実行してください':'Run AI OCR','この内容でカルテを保存':'Save consultation sheet','読取が完了しました。内容を確認してください':'OCR completed. Review the results.','カルテ画像と部位写真を保存しました':'Consultation sheet and treatment-area photos saved.',
  'ユーザーIDまたはパスワードが違います':'The user ID or password is incorrect.','ログイン試行回数が多すぎます。15分後にお試しください':'Too many sign-in attempts. Please try again in 15 minutes.','ログインする店舗を選択してください':'Select the salon to sign in to.','ログインが必要です':'Sign-in is required.','未払いのため、この店舗のサービスは一時停止されています。管理者へお問い合わせください':'This salon service is suspended. Contact your administrator.',
  'フェイシャル':'Facial','ボディ':'Body','フット':'Foot','途中経過':'Follow-up','新規登録':'New client','種類を判定中':'Identifying sheet','カメラ切替':'Switch camera','カメラの準備中です':'Preparing camera','シートを枠内に合わせてください。まもなく判定します':'Align the sheet inside the frame. Identification will begin shortly.','カルテ全体を枠内に合わせてください':'Align the entire sheet inside the frame','判定できません':'Unable to identify','検出':'Detected','撮影できます':'Ready to capture','別のカメラへ切り替えられませんでした':'Unable to switch cameras','カメラを起動できないため、画像ファイル選択へ切り替えます':'Camera unavailable. Switching to image selection.','施術部位を撮影':'Capture treatment area','施術部位を中央に合わせてください':'Center the treatment area','施術部位写真':'Treatment-area photo','シートを確認しました':'Sheet verified','シート種類を確認できませんでした':'Could not verify the sheet type','2枚目を追加':'Add page 2','画像が1枚不足しています。2枚目を追加してください':'Page 2 is missing. Add the second image.','画像は先頭の2枚を読み込みました':'The first two images were loaded.',
  '結果':'Result','お客様名':'Client name','施術日時':'Treatment date and time','担当':'Practitioner','施術内容・施術部位':'Treatment and areas','施術内容':'Treatment details','施術部位':'Treatment areas','使用商品':'Products used','使用ワックス':'Wax used','コメント':'Comments','物販':'Retail','割引':'Discount','金額':'Amount','割引後金額':'Amount after discount','お肌の状態':'Skin condition','気になること':'Concerns','お客様のご希望':'Client requests','注意事項・同意内容':'Cautions and consent','店舗':'Salon','担当者':'Practitioner','フリガナ':'Phonetic name','個人情報同意日':'Privacy consent date','西暦 年 月 日':'YYYY / MM / DD','OCR結果':'OCR result',
  'お客様名で検索':'Search by client name','電話番号で検索':'Search by phone','フリーワード検索':'Keyword search','男女で表示を切り替え':'Filter by gender','男女すべて':'All genders','お客様情報なし':'Client information unavailable','電話番号未登録':'Phone not registered','施術記録':'Treatment record','担当者未登録':'Practitioner not registered','該当する施術履歴はありません':'No matching treatment history','お客様情報を取得できません':'Unable to load client information','お名前・電話番号で検索':'Search name or phone','性別で絞り込み':'Filter by gender','すべて':'All','注意事項なし':'No cautions','履歴を見る':'View history','該当するお客様はいません':'No matching clients',
  'お客様情報を特定できません':'Unable to identify the client','施術履歴を読み込み中…':'Loading treatment history...','性別':'Gender','電話番号':'Phone','住所':'Address','職業':'Occupation','お客様カルテ':'Client record','施術前に注意事項を確認してください':'Review cautions before treatment','← 一覧に戻る':'← Back to list','一覧に戻る':'Back to list','カルテ運用区分':'Sheet category','施術前注意事項':'Pre-treatment cautions','登録なし':'None','お好み・ご希望':'Preferences and requests','関心ごと':'Interests','最終来店':'Last visit','初回登録情報':'Initial registration','編集':'Edit','施術タイムライン':'Treatment timeline','AIサマリ生成':'Generate AI summary','AIサマリ生成中…':'Generating AI summary...','AIサマリ':'AI summary','サマリを保存':'Save summary','サマリを保存しました':'Summary saved','注意':'Caution','施術履歴はありません':'No treatment history','登録店舗':'Registered salon','閲覧のみ':'View only','話題ポイント':'Conversation topics','話題を追加':'Add topic','話題を1行に1件ずつ入力してください':'Enter one topic per line','話題ポイントを保存しました':'Conversation topics saved','過去の施術から話題を蓄積します':'Topics are collected from past treatments','注意を追加':'Add caution','登録店舗で編集できます':'Editable at the registered salon','注意事項を1行に1件ずつ入力してください':'Enter one caution per line','好みを追加':'Add preference','好み・ご希望を1行に1件ずつ入力してください':'Enter one preference or request per line','施術履歴を表示できませんでした。':'Unable to display treatment history.','ホームへ戻る':'Return home',
  '正常稼働中':'Operating normally','最終更新':'Last updated','運用状況を更新':'Refresh status','サーバー稼働時間':'Server uptime','データ保存':'Data storage','ローカルJSON':'Local JSON','利用可能':'Available','店舗別の利用状況':'Usage by salon','会社名未登録':'Company not registered','ユーザー':'Users','お客様':'Clients','フォーム':'Forms','操作':'Actions','アカウント':'Account','契約会社':'Companies','管理者名':'Administrator name','追加する':'Add','追加先':'Add to','新しいパスワード':'New password','変更しない場合は空欄':'Leave blank to keep unchanged','パスワードは入力した場合のみ変更されます。':'The password changes only when entered.','変更を保存':'Save changes','登録情報を編集':'Edit registration','店舗・アカウントを追加':'Add salon and account','会社サービスを再開':'Resume company service','サービス停止':'Suspend service','会社全体を一時停止中':'Company suspended','会社全体で利用中':'Company active','無料枠':'Free tier','有料対象':'Paid clients','有料対象なし':'No paid clients','新しい契約会社を追加':'Add company','最初の店舗・アカウントを発行':'Create the first salon and account',
  'おはようございます':'Good morning','お疲れさまです':'Welcome','さん':'','お客様の大切な情報を、今日の施術に活かしましょう。':'Use each client’s information to provide better care today.','のカルテ':' consultation sheets','電話番号（任意）':'Phone number (optional)','選択してください':'Select','来店日':'Visit date','紐づけるお客様':'Link to client','スタッフメモ':'Staff notes','施術後の状態、次回への申し送りなど':'Post-treatment condition and notes for next visit','読取確度':'OCR confidence',
  '店舗管理者':'Salon administrator','施術者':'Practitioner','管理者作成・削除不可':'Created by administrator - cannot delete','アカウントがありません':'No accounts','テンプレートがありません':'No templates','読取範囲プレビュー':'OCR area preview','枠をクリックして編集':'Click an area to edit','テンプレート名':'Template name','切替':'Switch','項目を追加':'Add field','設定を保存':'Save settings','新しい項目':'New field','複数行':'Multiline','日付':'Date','高さ':'Height','幅':'Width','左':'Left','上':'Top'
}).forEach(([ja,en])=>englishText.set(ja,en));
const englishEntries=()=>[...englishText.entries()].sort((a,b)=>b[0].length-a[0].length);
let translationTimer=0,translationRunning=false;
const aiTranslationAttempted=new Set();
function translatedValue(value){if(state.uiLanguage!=='en')return value;let result=englishText.has(value)?englishText.get(value):value;if(!englishText.has(value))for(const [ja,en] of englishEntries())if(result.includes(ja))result=result.split(ja).join(en);return result.replace(/(\d{4})年(\d{1,2})月/g,'$1 / $2').replace(/(\d+)枚目/g,'Page $1').replace(/(\d+)件/g,'$1 records').replace(/(\d+)人/g,'$1 clients').replace(/、/g,', ')}
function scheduleDatabaseTranslation(){
  if(state.uiLanguage!=='en'||!state.token||translationRunning)return;
  clearTimeout(translationTimer);translationTimer=setTimeout(translateDatabaseTextOnScreen,120);
}
async function translateDatabaseTextOnScreen(){
  if(state.uiLanguage!=='en'||!state.token||translationRunning)return;
  const walker=document.createTreeWalker(document.body,NodeFilter.SHOW_TEXT),texts=[];let node;
  while((node=walker.nextNode())){const value=node.nodeValue.trim(),parent=node.parentElement,original=parent?.dataset.jaText||value;if(!original||!/[ぁ-んァ-ヶ一-龠々ー]/.test(translatedValue(original))||parent?.closest('script,style,input,textarea,[data-no-translate]')||aiTranslationAttempted.has(original))continue;texts.push(original)}
  const unique=[...new Set(texts)].slice(0,50);if(!unique.length)return;
  translationRunning=true;
  try{const result=await api('/api/translate',{method:'POST',body:JSON.stringify({texts:unique})});Object.entries(result.translations||{}).forEach(([ja,en])=>{englishText.set(ja,en);aiTranslationAttempted.add(ja)});translateUi()}catch(error){console.warn('Database translation unavailable:',error.message)}finally{translationRunning=false}
  if(texts.length>unique.length)scheduleDatabaseTranslation();
}
function translateUi(root=document.body){
  const walker=document.createTreeWalker(root,NodeFilter.SHOW_TEXT);let node;
  while((node=walker.nextNode())){const value=node.nodeValue,trimmed=value.trim();if(!trimmed)continue;if(!node.parentElement?.dataset.jaText&&/[ぁ-んァ-ヶ一-龠々ー]/.test(trimmed))node.parentElement.dataset.jaText=trimmed;const japanese=node.parentElement?.dataset.jaText;if(japanese){const translated=state.uiLanguage==='en'?translatedValue(japanese):japanese;node.nodeValue=value.replace(trimmed,translated)}}
  root.querySelectorAll?.('input[placeholder],textarea[placeholder]').forEach(field=>{if(!field.dataset.jaPlaceholder)field.dataset.jaPlaceholder=field.placeholder;if(state.uiLanguage==='ja')field.placeholder=field.dataset.jaPlaceholder;else field.placeholder=translatedValue(field.dataset.jaPlaceholder)});
  root.querySelectorAll?.('[title],[aria-label],[alt]').forEach(element=>['title','aria-label','alt'].forEach(attribute=>{if(!element.hasAttribute(attribute))return;const dataKey=`ja${attribute.split('-').map(part=>part[0].toUpperCase()+part.slice(1)).join('')}`;if(!element.dataset[dataKey]&&/[ぁ-んァ-ヶ一-龠々ー]/.test(element.getAttribute(attribute)))element.dataset[dataKey]=element.getAttribute(attribute);if(element.dataset[dataKey])element.setAttribute(attribute,state.uiLanguage==='en'?translatedValue(element.dataset[dataKey]):element.dataset[dataKey])}));
  scheduleDatabaseTranslation();
}
function applyUiLanguage(){document.documentElement.lang=state.uiLanguage;document.querySelectorAll('.language-switch button').forEach(button=>{const active=button.dataset.language===state.uiLanguage;button.classList.toggle('active',active);button.setAttribute('aria-pressed',String(active))});translateUi()}
document.querySelectorAll('.language-switch button').forEach(button=>button.onclick=()=>{state.uiLanguage=button.dataset.language;localStorage.setItem('salonUiLanguage',state.uiLanguage);applyUiLanguage()});
new MutationObserver(mutations=>{if(state.uiLanguage==='en')mutations.forEach(mutation=>{const target=mutation.target?.nodeType===Node.ELEMENT_NODE?mutation.target:mutation.target?.parentElement;if(target)translateUi(target)})}).observe(document.body,{childList:true,subtree:true});
applyUiLanguage();
...
async function api(url, options={}, attempt=0) {
  ...
  const tracksAi=method==='POST'&&(url.startsWith('/api/ocr')||/^\/api\/customers\/[^/]+\/summary$/.test(url));
  let response;
...
function normalizeChartLanguage(value){return value==='英語'||value==='en'?'en':value==='日本語'||value==='ja'?'ja':''}
function chartLanguageLabel(value){return value==='en'?'English':'日本語'}
function genderLabel(value){return value==='male'?'男性用':value==='female'?'女性用':value==='common'?'男女共通':'未設定'}
function recordTypeOf(record,visitNumber=1){return record?.recordType||(visitNumber===1?'registration_sheet':'treatment_entry')}
function recordHistoryLabel(record,visitNumber){return recordTypeOf(record,visitNumber)==='registration_sheet'?'初回 新規登録シート':`${visitNumber}回目 施術入力`}
const registrationHistoryFields=[['customerNo','お客様No.'],['name','お名前'],['kana','フリガナ'],['email','メール'],['phone','電話番号'],['address','住所'],['birthDate','生年月日'],['occupation','職業'],['skinCondition','肌の状態'],['footCondition','足の状態'],['lifestyle','生活習慣'],['hairRemovalHistory','脱毛歴'],['footCareHistory','フットケア歴'],['waxAreas','施術希望部位'],['bodyAreas','ボディ施術希望部位'],['dailyCare','日常ケア'],['otherNotes','その他']];
const treatmentHistoryFields=[['treatmentDetails','施術内容'],['productsUsed','使用商品'],['skinCondition','状態'],['cautions','注意事項'],['retail','物販'],['discount','割引'],['amount','金額'],['discountedAmount','割引後金額']];
function recordHistoryDetails(record,visitNumber){const fields=recordTypeOf(record,visitNumber)==='registration_sheet'?registrationHistoryFields:treatmentHistoryFields;return fields.map(([key,label])=>record.values?.[key]?`<div class="history-detail-row"><b>${esc(label)}</b><span>${esc(record.values[key])}</span></div>`:'').join('')}
function customerTopicPoints(records=[],preferences=[],manualTopicPoints=[]){
  ...
  const points=[...new Set(manualTopicPoints.map(value=>String(value).trim()).filter(Boolean))];
...
$('#loginForm').addEventListener('submit',async e=>{e.preventDefault();$('#loginError').textContent='';const submit=e.submitter;if(submit){submit.disabled=true;submit.textContent=state.uiLanguage==='en'?'Signing in...':'ログイン中…'}try{const b=Object.fromEntries(new FormData(e.target));b.userId=String(b.userId||'').trim();b.tenantId=String(b.tenantId||'').trim();const r=await api('/api/login',{method:'POST',body:JSON.stringify(b)});state.token=r.token;sessionStorage.setItem('salonToken',r.token);await boot(r.user)}catch(x){if(x.data?.code==='TENANT_SELECTION_REQUIRED'){const select=$('#tenantSelect');select.innerHTML=x.data.tenants.map(t=>`<option value="${esc(t.id)}">${esc(t.name)}</option>`).join('');select.required=true;$('#tenantField').classList.remove('hidden');$('#loginError').textContent=state.uiLanguage==='en'?'Select the salon to sign in to.':'ログインする店舗を選択してください'}else $('#loginError').textContent=state.uiLanguage==='en'?translatedValue(x.message):x.message}finally{if(submit&&$('#login').classList.contains('hidden')===false){submit.disabled=false;submit.textContent=state.uiLanguage==='en'?'Sign in':'ログイン'}}});
...
async function openTreatmentEntryForm(customerId='',anchor=null){
  document.querySelector('.treatment-entry-dialog')?.remove();
  try{
    if(typeof customerId==='string'&&customerId)state.selectedCustomerId=customerId;
    ...
    const dialog=document.createElement('section');dialog.className='treatment-entry-dialog card';
    dialog.innerHTML=`<form method="dialog" class="treatment-entry-form"><div class="treatment-entry-heading"><div><small>LYCON TREATMENT RECORD</small><h2>施術入力</h2></div><button type="button" class="ghost treatment-entry-close" aria-label="閉じる">×</button></div><div class="treatment-entry-fields"><label>お客様を選ぶ<select name="customerId" required><option value="">選択してください</option>${state.customers.map(customer=>`<option value="${customer.id}" ${state.selectedCustomerId===customer.id?'selected':''}>${esc(customer.name)}${customer.phone?`（${esc(customer.phone)}）`:''}</option>`).join('')}</select></label><label>施術日<input name="visitDate" type="date" value="${todayDateValue()}" required></label><label>施術メニュー<input name="treatment" placeholder="例：フェイシャルワックス"></label><label>使用ワックス・商品<input name="productsUsed" placeholder="例：LYCOJET、Soothing Cream"></label></div><div class="treatment-entry-textareas"><label>お肌・施術部位の状態<textarea name="skinCondition" rows="3"></textarea></label><label>施術内容<textarea name="treatmentDetails" rows="3"></textarea></label><label>注意事項・お客様のご希望<textarea name="cautions" rows="3"></textarea></label><label>施術コメント・次回申し送り<textarea name="comment" rows="3"></textarea></label></div><section class="treatment-diagrams"><div class="section-head"><div><h3>施術部位へ描画</h3><p>指またはマウスで、施術部位・赤み・注意箇所を記入できます。</p></div></div><div class="treatment-diagram-grid">${[['face','顔'],['foot','足'],['body','ボディ']].map(([type,label])=>`<article class="treatment-diagram-card"><div><b>${label}</b><button type="button" class="ghost clear-treatment-drawing" data-canvas="${type}">描画を消す</button></div><canvas class="treatment-drawing-canvas" data-diagram="${type}" width="420" height="520" aria-label="${label}の施術図"></canvas></article>`).join('')}</div></section><p class="error treatment-entry-error"></p><div class="treatment-entry-actions"><button type="button" class="ghost treatment-entry-cancel">キャンセル</button><button type="submit" class="primary">施術記録を保存</button></div></form>`;
    dialog.innerHTML=`<form class="treatment-entry-form digital-treatment-entry"><div class="treatment-entry-heading"><div><small>LYCON TREATMENT RECORD</small><h2>フェイシャル施術入力</h2></div><button type="button" class="ghost treatment-entry-close" aria-label="閉じる">×</button></div><div class="facial-customer-row"><label>お客様を選ぶ<select name="customerId" required><option value="">選択してください</option>${state.customers.map(customer=>`<option value="${customer.id}" ${state.selectedCustomerId===customer.id?'selected':''}>${esc(customer.name)}${customer.phone?`（${esc(customer.phone)}）`:''}</option>`).join('')}</select></label></div><div class="digital-treatment-sheet"><div class="digital-cell digital-label">施術日</div><div class="digital-cell digital-date"><input name="visitDate" type="date" value="${todayDateValue()}" required></div><div class="digital-cell digital-label">担当</div><div class="digital-cell"><input name="staff" value="${esc(state.user?.name||'')}"></div><div class="digital-cell digital-label digital-main-label"><span>施術内容</span><span>使用商品</span></div><div class="digital-cell digital-main-input"><textarea name="treatmentDetails" aria-label="施術内容"></textarea><textarea name="productsUsed" aria-label="使用商品"></textarea></div><div class="digital-cell digital-face-cell"><div class="digital-face-toolbar"><b>施術部位</b><button type="button" class="ghost clear-treatment-drawing" data-canvas="face">描画を消す</button></div><canvas class="treatment-drawing-canvas digital-face-canvas" data-diagram="face" width="420" height="520" aria-label="顔の施術図"></canvas><small>指またはマウスで顔図へ描画できます</small></div><div class="digital-cell digital-label">コメント</div><div class="digital-cell digital-comment"><textarea name="comment"></textarea></div><div class="digital-cell digital-label">物販</div><div class="digital-cell"><input name="retail"></div><div class="digital-cell digital-label">金額</div><div class="digital-cell"><input name="amount" inputmode="numeric"></div><div class="digital-cell digital-label">割引</div><div class="digital-cell"><input name="discount"></div></div><p class="error treatment-entry-error"></p><div class="treatment-entry-actions"><button type="button" class="ghost treatment-entry-cancel">キャンセル</button><button type="submit" class="primary">施術記録を保存</button></div></form>`;
    dialog.querySelector('.digital-treatment-sheet').insertAdjacentHTML('afterend',`<h3 class="foot-treatment-title">フット施術入力</h3><div class="digital-treatment-sheet digital-foot-sheet"><div class="digital-cell digital-label">施術日</div><div class="digital-cell digital-date"><input name="footVisitDate" type="date" value="${todayDateValue()}"></div><div class="digital-cell digital-label">担当</div><div class="digital-cell"><input name="footStaff" value="${esc(state.user?.name||'')}"></div><div class="digital-cell digital-label digital-main-label"><span>施術内容</span><span>使用商品</span></div><div class="digital-cell digital-main-input"><textarea name="footTreatmentDetails" aria-label="フット施術内容"></textarea><textarea name="footProductsUsed" aria-label="フット使用商品"></textarea></div><div class="digital-cell digital-face-cell digital-foot-cell"><div class="digital-face-toolbar"><b>足の施術部位</b><button type="button" class="ghost clear-treatment-drawing" data-canvas="template-foot">描画を消す</button></div><img class="lycon-foot-diagram" src="lycon-foot-diagram.png" alt="LYCONフット施術用の足図"><canvas class="treatment-drawing-canvas digital-face-canvas digital-foot-canvas" data-diagram="template-foot" width="420" height="520" aria-label="足の施術図"></canvas><small>指またはマウスで足図へ描画できます</small></div><div class="digital-cell digital-label">コメント</div><div class="digital-cell digital-comment"><textarea name="footComment"></textarea></div><div class="digital-cell digital-label">物販</div><div class="digital-cell"><input name="footRetail"></div><div class="digital-cell digital-label">割引</div><div class="digital-cell"><input name="footDiscount"></div><div class="digital-cell digital-label">金額</div><div class="digital-cell"><input name="footAmount" inputmode="numeric"></div></div>`);
    dialog.querySelector('.digital-foot-sheet').insertAdjacentHTML('afterend',`<h3 class="foot-treatment-title body-treatment-title">ボディ施術入力</h3><div class="digital-treatment-sheet digital-body-sheet"><div class="digital-cell digital-label">施術日</div><div class="digital-cell digital-date"><input name="bodyVisitDate" type="date" value="${todayDateValue()}"></div><div class="digital-cell digital-label">担当</div><div class="digital-cell"><input name="bodyStaff" value="${esc(state.user?.name||'')}"></div><div class="digital-cell digital-label digital-main-label"><span>施術内容</span><span>使用商品</span></div><div class="digital-cell digital-main-input"><textarea name="bodyTreatmentDetails" aria-label="ボディ施術内容"></textarea><textarea name="bodyProductsUsed" aria-label="ボディ使用商品"></textarea></div><div class="digital-cell digital-face-cell digital-body-cell"><div class="digital-face-toolbar"><b>ボディ施術部位</b><button type="button" class="ghost clear-treatment-drawing" data-canvas="template-body">描画を消す</button></div><img class="lycon-body-diagram" src="lycon-body-diagram.png" alt="LYCONボディ施術用の正面・背面図"><canvas class="treatment-drawing-canvas digital-face-canvas digital-body-canvas" data-diagram="template-body" width="540" height="640" aria-label="ボディの施術図"></canvas><small>指またはマウスでボディ図へ描画できます</small></div><div class="digital-cell digital-label">コメント</div><div class="digital-cell digital-comment"><textarea name="bodyComment"></textarea></div><div class="digital-cell digital-label">物販</div><div class="digital-cell"><input name="bodyRetail"></div><div class="digital-cell digital-label">割引</div><div class="digital-cell"><input name="bodyDiscount"></div><div class="digital-cell digital-label">金額</div><div class="digital-cell"><input name="bodyAmount" inputmode="numeric"></div></div>`);
    const faceCanvas=dialog.querySelector('.digital-face-canvas:not(.digital-foot-canvas):not(.digital-body-canvas)');
    faceCanvas.dataset.diagram='template-face';
    const faceImage=document.createElement('img');faceImage.className='lycon-face-diagram';faceImage.src='lycon-face-diagram.png';faceImage.alt='LYCONフェイシャル施術用の顔図';faceCanvas.insertAdjacentElement('beforebegin',faceImage);
    dialog.querySelector('.digital-face-toolbar .clear-treatment-drawing').dataset.canvas='template-face';
    const displayAnchor=anchor?.closest?.('.history-record-row')||anchor||$('.hero');
    if(displayAnchor)displayAnchor.insertAdjacentElement('afterend',dialog);else $('#content').prepend(dialog);
    const close=()=>dialog.remove();dialog.querySelector('.treatment-entry-close').onclick=close;dialog.querySelector('.treatment-entry-cancel').onclick=close;
    dialog.querySelectorAll('.treatment-drawing-canvas').forEach(canvas=>initializeTreatmentDrawing(canvas));
    dialog.querySelectorAll('.clear-treatment-drawing').forEach(button=>button.onclick=()=>{const canvas=dialog.querySelector(`[data-diagram="${button.dataset.canvas}"]`);initializeTreatmentDrawing(canvas,true)});
    const customerSelect=dialog.querySelector('[name="customerId"]');
    const treatmentField=dialog.querySelector('[name="treatmentDetails"]');
    const suggestionBox=document.createElement('div');suggestionBox.className='treatment-suggestions';suggestionBox.innerHTML='<small>施術内容候補</small><div class="treatment-suggestion-buttons"><span class="muted">お客様を選択すると候補を表示します</span></div>';treatmentField.insertAdjacentElement('afterend',suggestionBox);
    const productsField=dialog.querySelector('[name="productsUsed"]');
    const productSuggestionBox=document.createElement('div');productSuggestionBox.className='treatment-suggestions product-suggestions';productSuggestionBox.innerHTML='<small>使用商品候補</small><div class="treatment-suggestion-buttons"><span class="muted">お客様を選択すると候補を表示します</span></div>';productsField.insertAdjacentElement('afterend',productSuggestionBox);
    const footTreatmentField=dialog.querySelector('[name="footTreatmentDetails"]'),footProductsField=dialog.querySelector('[name="footProductsUsed"]');
    const footTreatmentSuggestions=document.createElement('div');footTreatmentSuggestions.className='treatment-suggestions';footTreatmentSuggestions.innerHTML='<small>フット施術内容候補</small><div class="treatment-suggestion-buttons"><span class="muted">お客様を選択すると候補を表示します</span></div>';footTreatmentField.insertAdjacentElement('afterend',footTreatmentSuggestions);
    const footProductSuggestions=document.createElement('div');footProductSuggestions.className='treatment-suggestions product-suggestions';footProductSuggestions.innerHTML='<small>フット使用商品候補</small><div class="treatment-suggestion-buttons"><span class="muted">お客様を選択すると候補を表示します</span></div>';footProductsField.insertAdjacentElement('afterend',footProductSuggestions);
    const bodyProductsField=dialog.querySelector('[name="bodyProductsUsed"]');
    const bodyProductSuggestions=document.createElement('div');bodyProductSuggestions.className='treatment-suggestions product-suggestions';bodyProductSuggestions.innerHTML='<small>ボディ使用商品候補</small><div class="treatment-suggestion-buttons"><span class="muted">お客様を選択すると候補を表示します</span></div>';bodyProductsField.insertAdjacentElement('afterend',bodyProductSuggestions);
    const bodyTreatmentField=dialog.querySelector('[name="bodyTreatmentDetails"]');
    const bodyTreatmentSuggestions=document.createElement('div');bodyTreatmentSuggestions.className='treatment-suggestions';bodyTreatmentSuggestions.innerHTML='<small>ボディ施術内容候補</small><div class="treatment-suggestion-buttons"><span class="muted">お客様を選択すると候補を表示します</span></div>';bodyTreatmentField.insertAdjacentElement('afterend',bodyTreatmentSuggestions);
    const commentField=dialog.querySelector('[name="comment"]');
    const commentSuggestionBox=document.createElement('div');commentSuggestionBox.className='treatment-suggestions comment-suggestions';commentSuggestionBox.innerHTML='<small>コメント候補</small><div class="treatment-suggestion-buttons"><span class="muted">施術内容・使用商品を選択すると候補を表示します</span></div>';commentField.insertAdjacentElement('afterend',commentSuggestionBox);
    const commentCandidates=()=>{const source=[treatmentField.value,productsField.value,footTreatmentField.value,footProductsField.value,bodyTreatmentField.value,bodyProductsField.value].join(' '),candidates=[];if(/フェイシャル|アイブロウ|Waxing/i.test(source))candidates.push('施術後の赤みとお肌の状態を確認しました','毛流れと左右のバランスを確認しながら仕上げました');if(/カウンセリング/i.test(source))candidates.push('施術前にお肌の状態とご希望を確認しました');if(/ハードワックス|ライコジェット|ライコテック/i.test(source))candidates.push('毛質と施術部位に合わせてワックスを使い分けました');if(/ローション|ジェル|クリーム|保湿|スクラブ/i.test(source))candidates.push('施術後に鎮静・保湿ケアを行いました');if(/フット|カルス|パドル|lyco'pedi|ソーク/i.test(source))candidates.push('足部の角質と乾燥状態を確認し、重点的にケアしました','ホームケアとして保湿を継続するようご案内しました');if(/ボディ|ストリップワックス/i.test(source))candidates.push('施術部位の反応を確認しながらボディワックスを行いました');return [...new Set(candidates.length?candidates:['施術後の状態を確認し、次回来店時の確認事項を共有しました'])]};
    const refreshCommentSuggestions=()=>renderOfficialProductSuggestions(customerSelect.value,commentSuggestionBox,commentField,commentCandidates());
    [treatmentField,productsField,footTreatmentField,footProductsField,bodyTreatmentField,bodyProductsField].forEach(field=>field.addEventListener('input',refreshCommentSuggestions));
    const retailFields=[dialog.querySelector('[name="retail"]'),dialog.querySelector('[name="footRetail"]'),dialog.querySelector('[name="bodyRetail"]')];
    const retailSuggestionBoxes=retailFields.map(field=>{const box=document.createElement('div');box.className='treatment-suggestions retail-history-suggestions';box.innerHTML='<small>再購入候補</small><div class="treatment-suggestion-buttons"><span class="muted">お客様を選択すると候補を表示します</span></div>';field.insertAdjacentElement('afterend',box);return box});
    const retailProductCandidates=[['イングロウンX-it クリーム 30g','イングロウンケア'],['イングロウンX-it ソリューション 125ml','イングロウンケア'],['イングロウンX-it ワイプ 40枚','イングロウンケア'],['アンチバンプ フォーミングジェル 250ml','洗浄ケア'],['ティーツリー スーズ 250ml','鎮静ケア'],['ティーツリー トータルウォッシュ 250ml','洗浄ケア'],['X-it ミット','角質ケア'],['PINKINI モイスチャライジングローション 500ml','デリケートゾーン保湿'],['PINKINI ライトニングセラム 30ml','デリケートゾーン美容液'],['PINKINI インティメイトウォッシュ 500ml','デリケートゾーン洗浄'],['PINKINI インティメイトエクスフォリエント 50ml','デリケートゾーン角質ケア'],['アップル＆クランベリー シュガースクラブ 520g','ボディ角質ケア'],['ココナッツ＆バニラ シュガースクラブ 520g','ボディ角質ケア'],['ラベンダー＆カモミール シュガースクラブ 520g','ボディ角質ケア'],['ミセラー フェイシャルクレンジングジェル 200ml','フェイシャル洗浄'],['リバイタライジング ヒアルロン＋B5 セラム 30ml','フェイシャル保湿']].map(([value,use])=>({value,label:`【店販】${value}｜${use}`}));
    const retailProductBoxes=retailSuggestionBoxes.map(historyBox=>{const box=document.createElement('div');box.className='treatment-suggestions retail-product-suggestions';box.innerHTML='<small>店販商品候補（お客様購入用）</small><div class="treatment-suggestion-buttons"><span class="muted">お客様を選択すると候補を表示します</span></div>';historyBox.insertAdjacentElement('afterend',box);return box});
    const refreshRetailProductSuggestions=()=>retailProductBoxes.forEach((box,index)=>renderOfficialProductSuggestions(customerSelect.value,box,retailFields[index],retailProductCandidates));
    const treatmentBasedRetailCandidates=index=>{const source=[index===0?treatmentField.value:index===1?footTreatmentField.value:bodyTreatmentField.value,index===0?productsField.value:index===1?footProductsField.value:bodyProductsField.value].join(' '),values=[];if(index===0){if(/フェイシャル|顔|アイブロウ|口まわり/i.test(source))values.push('ミセラー フェイシャルクレンジングジェル 200ml','リバイタライジング ヒアルロン＋B5 セラム 30ml');if(/ワックス|Waxing|産毛/i.test(source))values.push('イングロウンX-it クリーム 30g','ティーツリー スーズ 250ml')}if(index===1){if(/角質|カルス|パドル|スクラブ/i.test(source))values.push('X-it ミット','アップル＆クランベリー シュガースクラブ 520g');if(/乾燥|保湿|フット|足|かかと/i.test(source))values.push('イングロウンX-it クリーム 30g','ティーツリー スーズ 250ml')}if(index===2){if(/ブラジリアン|VIO|デリケート|PINKINI/i.test(source))values.push('PINKINI インティメイトウォッシュ 500ml','PINKINI モイスチャライジングローション 500ml','PINKINI インティメイトエクスフォリエント 50ml');if(/ボディ|角質|スクラブ/i.test(source))values.push('ココナッツ＆バニラ シュガースクラブ 520g','ラベンダー＆カモミール シュガースクラブ 520g');if(/ワックス|Waxing/i.test(source))values.push('イングロウンX-it ソリューション 125ml','ティーツリー スーズ 250ml')}const defaults=index===0?['ミセラー フェイシャルクレンジングジェル 200ml','リバイタライジング ヒアルロン＋B5 セラム 30ml','イングロウンX-it クリーム 30g']:index===1?['イングロウンX-it クリーム 30g','X-it ミット','ティーツリー スーズ 250ml']:['イングロウンX-it ソリューション 125ml','PINKINI モイスチャライジングローション 500ml','ココナッツ＆バニラ シュガースクラブ 520g'];return [...new Set([...values,...defaults])].slice(0,6).map(value=>({value,label:`${value}｜施術内容から`}))};
    const refreshRetailSuggestions=async()=>{const customerId=customerSelect.value;if(!customerId){retailSuggestionBoxes.forEach((box,index)=>renderOfficialProductSuggestions('',box,retailFields[index],[]));return}try{const records=await api('/api/records'),counts=new Map();records.filter(record=>record.customerId===customerId).forEach(record=>{const structured=Array.isArray(record.retailPurchases)?record.retailPurchases.map(purchase=>purchase.productName):[],history=structured.length?structured:[record.values?.retail||'',...String(record.note||'').matchAll(/物販:\s*([^/\n]+)/g)].map(value=>Array.isArray(value)?value[1]:value);history.flatMap(value=>String(value).split(/[\n,、／]+/)).map(value=>value.replace(/^物販:\s*/,'').trim()).filter(Boolean).forEach(value=>counts.set(value,(counts.get(value)||0)+1))});const historyCandidates=[...counts.entries()].sort((a,b)=>b[1]-a[1]||a[0].localeCompare(b[0],'ja')).slice(0,6).map(([value,count])=>({value,label:`${value}（過去${count}回）`}));retailSuggestionBoxes.forEach((box,index)=>{box.querySelector('small').textContent=historyCandidates.length?'再購入候補（過去の購入履歴）':'購入候補（施術内容から）';renderOfficialProductSuggestions(customerId,box,retailFields[index],historyCandidates.length?historyCandidates:treatmentBasedRetailCandidates(index))})}catch(error){retailSuggestionBoxes.forEach(box=>box.querySelector('.treatment-suggestion-buttons').innerHTML='<span class="muted">購入候補を読み込めませんでした</span>')}};
    const refreshSuggestions=()=>{loadTreatmentSuggestions(customerSelect.value,suggestionBox,treatmentField);loadProductSuggestions(customerSelect.value,productSuggestionBox,productsField);loadFootTreatmentSuggestions(customerSelect.value,footTreatmentSuggestions,footTreatmentField);loadFootProductSuggestions(customerSelect.value,footProductSuggestions,footProductsField);loadBodyTreatmentSuggestions(customerSelect.value,bodyTreatmentSuggestions,bodyTreatmentField);loadBodyProductSuggestions(customerSelect.value,bodyProductSuggestions,bodyProductsField);refreshCommentSuggestions();refreshRetailProductSuggestions();refreshRetailSuggestions()};
    customerSelect.addEventListener('change',refreshSuggestions);[treatmentField,productsField,footTreatmentField,footProductsField,bodyTreatmentField,bodyProductsField].forEach(field=>field.addEventListener('input',refreshRetailSuggestions));if(customerSelect.value)refreshSuggestions();
    dialog.querySelector('form').addEventListener('submit',()=>{const bodyTreatment=dialog.querySelector('[name="bodyTreatmentDetails"]')?.value.trim(),bodyProducts=dialog.querySelector('[name="bodyProductsUsed"]')?.value.trim(),bodyComment=dialog.querySelector('[name="bodyComment"]')?.value.trim(),bodyRetail=dialog.querySelector('[name="bodyRetail"]')?.value.trim(),bodyDiscount=dialog.querySelector('[name="bodyDiscount"]')?.value.trim(),bodyAmount=dialog.querySelector('[name="bodyAmount"]')?.value.trim(),commentField=dialog.querySelector('[name="comment"]');if(bodyTreatment)treatmentField.value=[treatmentField.value.trim(),`ボディ: ${bodyTreatment}`].filter(Boolean).join('\n');if(bodyProducts)productsField.value=[productsField.value.trim(),`ボディ: ${bodyProducts}`].filter(Boolean).join('\n');const bodyNotes=[bodyComment,bodyRetail&&`物販: ${bodyRetail}`,bodyDiscount&&`割引: ${bodyDiscount}`,bodyAmount&&`金額: ${bodyAmount}`].filter(Boolean).join(' / ');if(bodyNotes)commentField.value=[commentField.value.trim(),`ボディ: ${bodyNotes}`].filter(Boolean).join('\n')},{capture:true});
    dialog.querySelector('form').addEventListener('submit',()=>{const footTreatment=dialog.querySelector('[name="footTreatmentDetails"]')?.value.trim(),footProducts=dialog.querySelector('[name="footProductsUsed"]')?.value.trim(),footComment=dialog.querySelector('[name="footComment"]')?.value.trim(),footRetail=dialog.querySelector('[name="footRetail"]')?.value.trim(),footDiscount=dialog.querySelector('[name="footDiscount"]')?.value.trim(),footAmount=dialog.querySelector('[name="footAmount"]')?.value.trim(),commentField=dialog.querySelector('[name="comment"]');if(footTreatment)treatmentField.value=[treatmentField.value.trim()&&`フェイシャル: ${treatmentField.value.trim()}`,`フット: ${footTreatment}`].filter(Boolean).join('\n');if(footProducts)productsField.value=[productsField.value.trim()&&`フェイシャル: ${productsField.value.trim()}`,`フット: ${footProducts}`].filter(Boolean).join('\n');const footNotes=[footComment,footRetail&&`物販: ${footRetail}`,footDiscount&&`割引: ${footDiscount}`,footAmount&&`金額: ${footAmount}`].filter(Boolean).join(' / ');if(footNotes)commentField.value=[commentField.value.trim(),`フット: ${footNotes}`].filter(Boolean).join('\n')},{capture:true});
    const form=dialog.querySelector('form');form.onsubmit=async event=>{event.preventDefault();const submit=form.querySelector('[type="submit"]'),error=form.querySelector('.treatment-entry-error'),values=Object.fromEntries(new FormData(form));if(!values.customerId){error.textContent='お客様を選択してください';return}submit.disabled=true;error.textContent='';try{const template=state.templates[0];if(!template)throw new Error('保存用フォームがありません');const retailPurchases=[...new Set([values.retail,values.footRetail,values.bodyRetail].flatMap(value=>String(value||'').split(/[\n,、／]+/)).map(value=>value.trim()).filter(Boolean))],images=[...dialog.querySelectorAll('.treatment-drawing-canvas')].map(canvas=>canvas.toDataURL('image/png'));await api('/api/records',{method:'POST',body:JSON.stringify({customerId:values.customerId,visitDate:values.visitDate,templateId:template.id,recordType:'treatment_entry',values:{treatment:values.treatment||'LYCON施術',treatmentDetails:values.treatmentDetails,productsUsed:values.productsUsed,skinCondition:values.skinCondition,cautions:values.cautions,retail:retailPurchases.join('\n'),discount:values.discount,amount:values.amount,discountedAmount:values.discountedAmount},retailPurchases,alerts:values.cautions?[values.cautions]:[],note:values.comment,images})});state.selectedCustomerId=values.customerId;toast('LYCON施術記録を保存しました');close();show('dashboard')}catch(saveError){error.textContent=saveError.message;submit.disabled=false}};
    dialog.scrollIntoView({behavior:'smooth',block:'start'});
  }catch(error){toast(error.message)}
}
async function loadTreatmentSuggestions(customerId,container,field){
  renderOfficialProductSuggestions(customerId,container,field,['フェイシャルWaxingのアプリケーション','アイブロウの形と整え方','施術前後のカウンセリング','フェイスラインの産毛ケア','口まわりの細部ワックス','施術後の鎮静・保湿ケア']);
}
async function loadProductSuggestions(customerId,container,field){
  renderOfficialProductSuggestions(customerId,container,field,['ライコジェット アイブロウワックス 500g','ライコテック ホワイトハードワックス 500g','アフターワックスローションS （ミルクタイプ）500ml','ロゼット パステル ハードワックス 1kg','アズレン ハードワックス 1kg','ライコドリーム ハイブリッドワックス 500g','ライコタン スキンクレンザー 500ml','プレワックス オイル 500ml','スージングクリーム 500ml','ティーツリー スーズ 500ml','パーフェクトフィニッシュ 500ml','アロエベラ スージングジェル 500ml','イングロウンX-it クリーム 30g','イングロウンX-it ソリューション 125ml']);
}
async function loadFootTreatmentSuggestions(customerId,container,field){
  const fallbacks=['リフレッシングソークを使ったフットバス','カルスリムーバーとフットパドルによる角質ケア','シュガースクラブとマッサージングローションによる保湿ケア','足裏の硬い角質を重点的にケア','かかとの乾燥部分を集中保湿','フットケア後のホームケア案内'];
  renderOfficialProductSuggestions(customerId,container,field,fallbacks);
}
async function loadFootProductSuggestions(customerId,container,field){
  const fallbacks=["lyco'pedi リフレッシングソーク 500ml","lyco'pedi カルスリムーバー 100ml","lyco'pedi スムージングクリーム 250ml","lyco'pedi シュガースクラブ","lyco'pedi マッサージングローション","lyco'pedi フットパドル","イングロウンX-it クリーム 30g","イングロウンX-it ソリューション 125ml","アンチバンプ フォーミングジェル 250ml","ティーツリー トータルウォッシュ 250ml","ティーツリー スーズ 250ml","X-it ミット"];
  renderOfficialProductSuggestions(customerId,container,field,fallbacks);
}
async function loadBodyProductSuggestions(customerId,container,field){
  const fallbacks=['アクティブゴールド ストリップワックス 800ml','ライコテック ホワイトストリップワックス 800ml','アフターワックスジェル 500ml','アズレン ストリップワックス 800ml','ソーベリー デリシャス ストリップワックス 800ml','アロエベラ ストリップワックス 800ml','ロゼット ストリップワックス 800ml','MANifico ストリップワックス 800ml','PINKINI ブラジリアン ハイブリッドワックス 1kg','PINKINI スキンクレンザー 500ml','PINKINI プレワックス オイル 500g','PINKINI フィニッシングローション 500ml','ライコタン スキンクレンザー 500ml','プレワックス オイル 500ml','パーフェクトフィニッシュ 500ml','アロエベラ スージングジェル 500ml'];
  renderOfficialProductSuggestions(customerId,container,field,fallbacks);
}
async function loadBodyTreatmentSuggestions(customerId,container,field){
  const fallbacks=['ボディWaxingのアプリケーション','ストリップワックスとハードワックスの使い分け','施術前後のカウンセリング','毛質に合わせたワックス温度の調整','施術部位ごとの細部仕上げ','施術後の鎮静ジェルケア'];
  renderOfficialProductSuggestions(customerId,container,field,fallbacks);
}
function renderOfficialProductSuggestions(customerId,container,field,products){
  const buttons=container.querySelector('.treatment-suggestion-buttons');
  if(!customerId){buttons.innerHTML='<span class="muted">お客様を選択すると候補を表示します</span>';return}
  const queue=products.map(item=>typeof item==='string'?{value:item,label:item}:{value:item.value,label:item.label||item.value});
  buttons.innerHTML='';
  const addNextSuggestion=()=>{const item=queue.shift();if(!item)return false;const button=document.createElement('button');button.type='button';button.className='treatment-suggestion-chip';button.dataset.value=item.value;button.textContent=item.label;button.onclick=()=>{if(button.disabled)return;button.disabled=true;field.value=[field.value.trim(),item.value].filter(Boolean).join('\n');field.dispatchEvent(new Event('input',{bubbles:true}));field.focus({preventScroll:true});button.classList.add('is-removing');setTimeout(()=>{button.remove();addNextSuggestion();if(!buttons.querySelector('.treatment-suggestion-chip'))buttons.innerHTML='<span class="muted">選択できる候補はありません</span>'},100)};buttons.append(button);return true};
  for(let index=0;index<3;index+=1)addNextSuggestion();
  if(!buttons.querySelector('.treatment-suggestion-chip'))buttons.innerHTML='<span class="muted">選択できる候補はありません</span>';
}
function initializeTreatmentDrawing(canvas,reset=false){
  const context=canvas.getContext('2d');
  if(reset||!canvas.dataset.ready){context.clearRect(0,0,canvas.width,canvas.height);if(!canvas.dataset.diagram.startsWith('template-'))drawTreatmentDiagramBase(context,canvas.dataset.diagram);canvas.dataset.ready='true'}
  if(canvas.dataset.bound)return;canvas.dataset.bound='true';canvas.style.touchAction='none';let drawing=false,last=null;
  ...
  canvas.addEventListener('pointermove',event=>{if(!drawing)return;const next=point(event);context.beginPath();context.moveTo(last.x,last.y);context.lineTo(next.x,next.y);context.strokeStyle='#d51f62';context.lineWidth=5;context.lineCap='round';context.lineJoin='round';context.stroke();last=next;event.preventDefault()});
  const stop=()=>{drawing=false;last=null};canvas.addEventListener('pointerup',stop);canvas.addEventListener('pointercancel',stop);
}
function drawTreatmentDiagramBase(context,type){
  context.fillStyle='#fffdfd';context.fillRect(0,0,420,520);context.strokeStyle='#7d7779';context.fillStyle='#f9eef2';context.lineWidth=3;context.lineCap='round';context.lineJoin='round';
  if(type==='face'){
    context.beginPath();context.ellipse(210,245,125,175,0,0,Math.PI*2);context.fill();context.stroke();context.beginPath();context.moveTo(145,215);context.quadraticCurveTo(170,195,190,215);context.moveTo(230,215);context.quadraticCurveTo(255,195,275,215);context.moveTo(210,225);context.lineTo(195,295);context.lineTo(220,295);context.moveTo(160,335);context.quadraticCurveTo(210,365,260,335);context.stroke();
  }else if(type==='foot'){
    [[130,0],[290,Math.PI]].forEach(([x,rotation])=>{context.save();context.translate(x,275);context.rotate(rotation);context.beginPath();context.ellipse(0,20,66,150,0,0,Math.PI*2);context.fill();context.stroke();[-44,-22,0,22,44].forEach((dx,index)=>{context.beginPath();context.arc(dx,-142-Math.abs(index-2)*5,15-Math.abs(index-2)*1.4,0,Math.PI*2);context.fill();context.stroke()});context.restore()});
  }else{
    const drawBody=x=>{context.beginPath();context.arc(x,78,34,0,Math.PI*2);context.moveTo(x,112);context.lineTo(x,325);context.moveTo(x,150);context.lineTo(x-75,270);context.moveTo(x,150);context.lineTo(x+75,270);context.moveTo(x,325);context.lineTo(x-48,485);context.moveTo(x,325);context.lineTo(x+48,485);context.stroke();context.beginPath();context.ellipse(x,225,72,115,0,0,Math.PI*2);context.fill();context.stroke()};drawBody(120);drawBody(300);
  }
  context.fillStyle='#6f686b';context.font='bold 15px sans-serif';context.textAlign='center';context.fillText(type==='face'?'FACE':type==='foot'?'FEET':'FRONT / BACK',210,505);
}
function openChartFiles(stage){
  ...
  picker.onchange=async()=>{const files=[...picker.files].slice(0,stage==='new'?2:1);if(!files.length){picker.remove();return}try{const images=await Promise.all(files.map(optimizeImageFile));const result=await api('/api/ocr/validate-sheet',{method:'POST',body:JSON.stringify({images:[images[0]],expectedType:'',workflowStage:stage,captureKind:'chart'})});const chartLanguage=normalizeChartLanguage(result.detectedLanguage)||'ja';const chartGender=result.detectedType==='フット'||chartLanguage==='en'?'common':normalizeChartGender(result.detectedGender);if(!result.valid||!['フット','フェイシャル','ボディ'].includes(result.detectedType)||!chartGender)throw new Error('カルテの言語・種類・男性用／女性用を判定できませんでした');state.treatmentType=result.detectedType;state.chartGender=chartGender;state.chartLanguage=chartLanguage;state.workflowStage=stage;state.images=images;state.image=images[0];state.scan=null;showOcrFormForSelectedButton()}catch(error){toast(error.message)}finally{picker.remove()}};picker.click();
}
...
async function captureChartPhoto(stage){
  ...
  const requiredPages=stage==='new'?2:1,captured=[];let detectedType='',detectedGender='',detectedLanguage='';
  ...
  const detectLiveSheet=async run=>{if(run!==liveRun||liveChecking||!dialog.open)return;const image=liveFrame();if(!image){scheduleLiveDetection(run,700);return}liveChecking=true;liveStatus.className='camera-live-status is-checking';liveStatus.textContent='AIがカルテの言語・種類・男性用／女性用を判定中…';try{const result=await api('/api/ocr/validate-sheet',{method:'POST',body:JSON.stringify({images:[image],expectedType:detectedType,expectedGender:detectedGender,expectedLanguage:detectedLanguage,workflowStage:stage,captureKind:'chart'})});if(run!==liveRun||!dialog.open)return;const chartLanguage=normalizeChartLanguage(result.detectedLanguage)||'ja';const chartGender=result.detectedType==='フット'||chartLanguage==='en'?'common':normalizeChartGender(result.detectedGender);if(result.valid&&['フット','フェイシャル','ボディ'].includes(result.detectedType)&&chartGender){detectedType=result.detectedType;detectedGender=chartGender;detectedLanguage=chartLanguage;title.textContent=`${chartLanguageLabel(detectedLanguage)}・${genderLabel(detectedGender)} ${detectedType} カルテ撮影`;shutter.disabled=false;shutter.textContent=captured.length?'2枚目を撮影':'撮影';liveStatus.className='camera-live-status is-valid';liveStatus.textContent=`✓ ${chartLanguageLabel(detectedLanguage)}・${genderLabel(detectedGender)}・${detectedType}・${stage==='progress'?'途中経過':'新規登録'}を確認しました。撮影できます`;return}const detected=[result.detectedCaptureKind,result.detectedLanguage,result.detectedType,result.detectedGender,result.detectedStage].filter(value=>value&&value!=='不明').join('・')||'判定できません';liveStatus.className='camera-live-status is-warning';liveStatus.textContent=`⚠ 検出：${detected}。カルテ全体を枠内に合わせてください`}catch(error){if(run!==liveRun||!dialog.open)return;liveStatus.className='camera-live-status is-warning';liveStatus.textContent='AI判定を再試行します。シートを枠内で静止させてください'}finally{liveChecking=false;if(run===liveRun&&dialog.open&&!liveStatus.classList.contains('is-valid'))scheduleLiveDetection(run)}};
  ...
  shutter.onclick=()=>{if(!detectedType||!detectedGender||!detectedLanguage){toast('カルテの言語・種類・男性用／女性用の判定を待ってください');return}if(!video.videoWidth||!video.videoHeight){toast('カメラの準備中です');return}const scale=Math.min(1,2000/Math.max(video.videoWidth,video.videoHeight));const canvas=document.createElement('canvas');canvas.width=Math.round(video.videoWidth*scale);canvas.height=Math.round(video.videoHeight*scale);canvas.getContext('2d',{alpha:false}).drawImage(video,0,0,canvas.width,canvas.height);captured.push(canvas.toDataURL('image/jpeg',.82));if(captured.length<requiredPages){updateGuide();startLiveDetection();return}state.treatmentType=detectedType;state.chartGender=detectedGender;state.chartLanguage=detectedLanguage;state.workflowStage=stage;state.images=captured;state.image=captured[0];state.scan=null;dialog.close();showOcrFormForSelectedButton()};
}
...
async function validateDisplayedSheets(){
  ...
  try{
    const result=await api('/api/ocr/validate-sheet',{method:'POST',body:JSON.stringify({images,expectedType:state.treatmentType,expectedGender:state.chartGender,expectedLanguage:state.chartLanguage,workflowStage:state.workflowStage})});
...
async function runSelectedFacialOcr(){
  ...
  try{const images=state.images.length?state.images:[state.image];const result=await api('/api/ocr/facial',{method:'POST',body:JSON.stringify({images,chartGender:state.chartGender,chartLanguage:state.chartLanguage})});['kana','customerNo','name','email','phone','address','birthDate','occupation','skinCondition','lifestyle','hairRemovalHistory','consentDate','consentName','treatmentConsentDate','treatmentConsentName','waxAreas','cosmetics','dailyCare'].forEach(key=>{const field=frame.querySelector(`[name="${key}"]`);if(field)field.value=result[key]||''});markOcrReady(frame);toast(`${chartLanguageLabel(state.chartLanguage)} ${images.length}枚のOCR結果を反映しました`)}catch(error){toast(error.message)}finally{button.disabled=false;button.textContent='OCR'}
}
...
async function runSelectedBodyOcr(){
  ...
  try{const images=state.images.length?state.images:[state.image];const result=await api('/api/ocr/body',{method:'POST',body:JSON.stringify({images,chartGender:state.chartGender,chartLanguage:state.chartLanguage})});['kana','customerNo','name','email','phone','address','birthDate','occupation','skinCondition','lifestyle','hairRemovalHistory','consentDate','consentName','treatmentConsentDate','treatmentConsentName','bodyAreas','vioDesign','cosmetics','dailyCare'].forEach(key=>{const field=frame.querySelector(`[name="${key}"]`);if(field)field.value=result[key]||''});markOcrReady(frame);toast(`${chartLanguageLabel(state.chartLanguage)} ${images.length}枚のOCR結果を反映しました`)}catch(error){toast(error.message)}finally{button.disabled=false;button.textContent='OCR'}
}
function showSelectedImagePreview(){
  ...
  frame.querySelector('.badge').textContent=`${chartLanguageLabel(state.chartLanguage)}・フット ${images.length}枚`;
...
async function saveOcrRecord(frame,button){
  ...
  try{
    ...
    values.chartLanguage=state.chartLanguage;
    const images=imagesForRecord();
    const visitDate=todayDateValue();
    await api('/api/records',{method:'POST',body:JSON.stringify({customerId:customer.id,visitDate,templateId:template.id,chartGender:state.chartGender,recordType:'registration_sheet',values,alerts:[],note:`${chartLanguageLabel(state.chartLanguage)} ${genderLabel(state.chartGender)} ${treatmentLabel} OCRから保存`,images})});
...
async function runSelectedFootOcr(){
  ...
  try{const images=state.images.length?state.images:[state.image];const result=await api('/api/ocr/foot',{method:'POST',body:JSON.stringify({images,chartLanguage:state.chartLanguage})});['kana','customerNo','name','email','phone','address','birthDate','occupation','footCondition','lifestyle','footCareHistory','consentDate','consentName','treatmentConsentDate','treatmentConsentName','skinTone','keratinCondition','dailyCare','otherNotes'].forEach(key=>{const field=frame.querySelector(`[name="${key}"]`);if(field)field.value=result[key]||''});markOcrReady(frame);toast(`${chartLanguageLabel(state.chartLanguage)} ${images.length}枚のOCR結果を入力欄へ反映しました`)}catch(error){toast(error.message)}finally{button.disabled=false;button.textContent='OCR'}
}
async function openDashboardAccountManagement(){
  if(!$('#dashboardAccountPanel'))await show('dashboard');
  $('#dashboardAccountPanel')?.scrollIntoView({behavior:'smooth',block:'start'});
  $('#dashboardAccountPanel input')?.focus({preventScroll:true});
}
async function setupDashboardAccountPanel(){
  if(state.user.role!=='owner')return;
  const panel=document.createElement('section');
  panel.id='dashboardAccountPanel';
  panel.className='dashboard-account-panel';
  $('#content').append(panel);
  await renderAccounts(panel,true);
}
async function enhanceCurrentView(name){
  ...
  if(heading)heading.textContent='AIカルテ';
  ...
  await setupDashboardAccountPanel();
}
async function setupDashboardPatientSearch(sectionHead){
  ...
  try{
    ...
    const filterPatients=()=>{
      ...
      resultCard.innerHTML=matches.map(record=>{const customer=record.customer||customers.find(item=>item.id===record.customerId)||{},recordGender=customer.gender||record.chartGender||'';return `<div class="record-row history-record-row"><div class="date-box"><b>${esc(String(record.visitDate||'').slice(8,10)||'--')}</b>${esc(String(record.visitDate||'').slice(5,7).replace(/^0/,'')||'--')}月</div><div><b>${esc(customer.name||'お客様情報なし')}</b><small class="muted">${esc(customer.phone||'電話番号未登録')}</small></div><div><b>${esc(record.values?.treatment||'施術記録')}</b><small class="muted">${esc(record.note||record.values?.concern||'')}</small></div><div><span class="badge gender-badge ${esc(recordGender||'unset')}">${esc(genderLabel(recordGender))}</span> <span class="badge">${esc(record.staff||'担当者未登録')}</span></div><button type="button" class="ghost detail-button-active" data-customer-id="${esc(record.customerId)}">施術履歴</button></div>`}).join('')||'<div class="empty">該当する施術履歴はありません</div>';
      resultCard.querySelectorAll('.detail-button-active[data-customer-id]').forEach(button=>{button.onclick=async()=>{const customerId=button.dataset.customerId;button.disabled=true;button.textContent='読み込み中…';await openCustomer(customerId);if(button.isConnected){button.disabled=false;button.textContent='施術履歴'}}});
    };
...
async function renderDashboard(){const d=await api('/api/dashboard'),now=new Date(),calendarMonth=`${now.getFullYear()}年${now.getMonth()+1}月`;$('#content').innerHTML=`<section class="home-identity"><div><small>契約会社名</small><b>${esc(state.user.tenant.companyName||'未登録')}</b></div><div><small>店舗名</small><b>${esc(state.user.tenant.name)}</b></div></section><section class="hero"><div><h2>${new Date().getHours()<12?'おはようございます':'お疲れさまです'}、${esc(state.user.name.split(' ')[0])}さん</h2><p>お客様の大切な情報を、今日の施術に活かしましょう。</p></div><button class="primary" onclick="show('scan')">＋ カルテを読み取る</button></section><div class="stats"><div class="card stat"><div><small>登録お客様</small><b>${d.customers}</b> 人</div><i>♙</i></div><div class="card stat"><div><small>${calendarMonth}のカルテ</small><b>${d.recordsThisMonth}</b> 件</div><i>▤</i></div><div class="card stat"><div><small>注意事項あり</small><b>${d.alerts}</b> 人</div><i>!</i></div></div><div class="section-head"><h2>最近の施術記録</h2><button class="link-btn" onclick="show('customers')">すべて見る →</button></div><div class="card">${d.recent.length?d.recent.map(r=>`<div class="record-row"><div class="date-box"><b>${r.visitDate.slice(8)}</b>${Number(r.visitDate.slice(5,7))}月</div><div><b>${esc(r.customer?.name)}</b><small class="muted">${esc(r.staff)} 担当</small></div><div>${esc(r.values.treatment||'施術記録')}</div><div>${r.alerts?.length?'<span class="badge alert">! 注意事項あり</span>':'<span class="badge">確認済み</span>'}</div><button class="ghost" onclick="openCustomer('${r.customerId}')">施術履歴</button></div>`).join(''):'<div class="empty">まだ記録がありません</div>'}</div>`}
...
async function openCustomer(id){
  if(!id){toast('お客様情報を特定できません');return}
  const content=$('#content');
  content.innerHTML='<div class="empty">施術履歴を読み込み中…</div>';
  try{
  const d=await api(`/api/customers/${encodeURIComponent(id)}`);
  d.records=(Array.isArray(d.records)?d.records:[]).map(record=>({values:{},alerts:[],...record,values:record?.values&&typeof record.values==='object'?record.values:{},alerts:Array.isArray(record?.alerts)?record.alerts:[]}));
  const c={alerts:[],preferences:[],...(d.customer||{})};
  c.alerts=Array.isArray(c.alerts)?c.alerts:[];
  c.preferences=Array.isArray(c.preferences)?c.preferences:[];
  const recordsOldestFirst=[...d.records].sort((a,b)=>String(a.visitDate||'').localeCompare(String(b.visitDate||'')));
  const visitNumbers=new Map(recordsOldestFirst.map((record,index)=>[record.id,index+1]));
  ...
  const topicPoints=customerTopicPoints(d.records,c.preferences,c.manualTopicPoints||[]);
  $('#pageTitle').textContent='お客様カルテ';$('#pageSub').textContent='施術前に注意事項を確認してください';
  $('#content').innerHTML=`<button type="button" class="ghost" id="backToCustomers">← 一覧に戻る</button><div class="detail-grid" style="margin-top:18px"><section class="card profile"><div class="avatar">${esc(c.name[0])}</div><h2>${esc(c.name)}</h2><p class="muted">${esc(c.kana)}<br>${esc(c.phone)}</p><div class="customer-gender-control"><label>カルテ運用区分<select id="customerGender" ${d.canEdit?'':'disabled'}><option value="" ${!c.gender?'selected':''}>未設定</option><option value="male" ${c.gender==='male'?'selected':''}>男性用</option><option value="female" ${c.gender==='female'?'selected':''}>女性用</option></select></label></div><div class="alert-box"><b>⚠ 施術前注意事項</b>${c.alerts.length?`<ul>${c.alerts.map(x=>`<li>${esc(x)}</li>`).join('')}</ul>`:'<p>登録なし</p>'}</div><h3>お好み・ご希望</h3><ul>${c.preferences.map(x=>`<li>${esc(x)}</li>`).join('')||'<li>登録なし</li>'}</ul><p class="muted last-visit">最終来店：${fmt(c.lastVisit)}</p><section class="customer-basic-info"><div class="customer-basic-info-heading"><h3>初回登録情報</h3>${d.canEdit?'<button type="button" class="ghost" id="editBasicInfo">編集</button>':''}</div><div id="basicInfoView">${basicInfo.map(([label,value])=>`<div><small>${esc(label)}</small><span>${esc(value||'未登録')}</span></div>`).join('')}</div><form id="basicInfoForm" class="customer-basic-info-form hidden"><label>お名前<input name="name" required value="${esc(c.name)}"></label><label>フリガナ<input name="kana" value="${esc(first.kana||c.kana||'')}"></label><label>お客様No.<input name="customerNo" value="${esc(first.customerNo||'')}"></label><label>メール<input name="email" type="email" value="${esc(first.email||'')}"></label><label>電話番号<input name="phone" value="${esc(first.phone||c.phone||'')}"></label><label>住所<input name="address" value="${esc(first.address||'')}"></label><label>生年月日<input name="birthDate" value="${esc(first.birthDate||'')}"></label><label>職業<input name="occupation" value="${esc(first.occupation||'')}"></label><div class="customer-basic-info-actions"><button type="button" class="ghost" id="cancelBasicInfo">キャンセル</button><button type="submit" class="primary">保存</button></div><p class="error" id="basicInfoError"></p></form></section></section><section><div class="section-head"><h2>施術タイムライン</h2><button type="button" class="primary" id="generateTreatmentSummary">サマリ生成</button></div><section class="card treatment-summary hidden" id="treatmentSummary" data-no-translate><h3>AIサマリ</h3><div id="treatmentSummaryText"></div></section><div class="timeline">${d.records.map(r=>{const visitNumber=visitNumbers.get(r.id)||1;return `<article class="card"><div class="field-head"><b>${fmt(r.visitDate)}</b><span><span class="badge record-type-badge">${esc(recordHistoryLabel(r,visitNumber))}</span> <span class="badge">${esc(r.staff)}</span></span></div>${r.alerts.length?`<div class="alert-box"><b>注意</b> ${r.alerts.map(esc).join(' ／ ')}</div>`:''}<h3>${esc(r.values.treatment||recordHistoryLabel(r,visitNumber))}</h3><p>${esc(r.note||r.values.concern||'')}</p><div class="history-details">${recordHistoryDetails(r,visitNumber)}</div></article>`}).join('')||'<div class="empty">施術履歴はありません</div>'}</div></section></div>`;
  const summaryButton=$('#generateTreatmentSummary'),summaryPanel=$('#treatmentSummary');
  summaryButton.textContent=state.uiLanguage==='en'?'Generate AI summary':'AIサマリ生成';
  summaryPanel.innerHTML='<h3>AIサマリ</h3><textarea id="treatmentSummaryText" rows="14" aria-label="AIサマリ"></textarea><div class="summary-actions"><small id="summaryUpdatedAt" class="muted"></small><button type="button" class="primary" id="saveTreatmentSummary">サマリを保存</button></div>';
  const summaryText=$('#treatmentSummaryText'),summarySaveButton=$('#saveTreatmentSummary'),summaryUpdatedAt=$('#summaryUpdatedAt');
  if(c.aiSummary){summaryText.value=String(c.aiSummary).replace(/・/g,'');summaryPanel.classList.remove('hidden');summaryUpdatedAt.textContent=c.summaryUpdatedAt?new Date(c.summaryUpdatedAt).toLocaleString(state.uiLanguage==='en'?'en-US':'ja-JP'):''}
  const updateInterestList=interests=>{const list=$('#customerInterests');if(list)list.innerHTML=(interests||[]).map(value=>`<li>${esc(value)}</li>`).join('')||'<li>登録なし</li>'};
  summaryButton.onclick=async()=>{summaryButton.disabled=true;summaryButton.textContent=state.uiLanguage==='en'?'Generating AI summary...':'AIサマリ生成中…';summaryPanel.classList.remove('hidden');summaryText.value=state.uiLanguage==='en'?'Generating AI summary...':'AIサマリ生成中…';try{const result=await api(`/api/customers/${id}/summary`,{method:'POST',body:JSON.stringify({language:state.uiLanguage})});summaryText.value=result.summary||'';summaryUpdatedAt.textContent=new Date(result.updatedAt).toLocaleString(state.uiLanguage==='en'?'en-US':'ja-JP');updateInterestList(result.interests)}catch(error){summaryText.value=error.message}finally{summaryButton.disabled=false;summaryButton.textContent=state.uiLanguage==='en'?'Generate AI summary':'AIサマリ生成'}};
  summarySaveButton.onclick=async()=>{summarySaveButton.disabled=true;try{const result=await api(`/api/customers/${id}/summary`,{method:'PUT',body:JSON.stringify({summary:summaryText.value})});summaryUpdatedAt.textContent=new Date(result.updatedAt).toLocaleString(state.uiLanguage==='en'?'en-US':'ja-JP');toast(state.uiLanguage==='en'?'Summary saved':'サマリを保存しました')}catch(error){toast(error.message)}finally{summarySaveButton.disabled=false}};
  const profileContact=$('.profile > p.muted');
  $('.customer-gender-control')?.remove();
  ...
  if(editBasicInfo&&basicInfoForm){const genderField=document.createElement('label');genderField.innerHTML=`性別<select name="gender" required><option value="female" ${c.gender==='female'?'selected':''}>女性</option><option value="male" ${c.gender==='male'?'selected':''}>男性</option></select>`;basicInfoForm.elements.name.closest('label').insertAdjacentElement('afterend',genderField);const toggleBasicInfo=editing=>{basicInfoView.classList.toggle('hidden',editing);basicInfoForm.classList.toggle('hidden',!editing);editBasicInfo.classList.toggle('hidden',editing);if(editing)basicInfoForm.elements.name.focus()};editBasicInfo.onclick=()=>toggleBasicInfo(true);$('#cancelBasicInfo').onclick=()=>toggleBasicInfo(false);basicInfoForm.onsubmit=async event=>{event.preventDefault();const button=event.submitter,values=Object.fromEntries(new FormData(basicInfoForm));button.disabled=true;$('#basicInfoError').textContent='';try{await api(`/api/customers/${id}`,{method:'PUT',body:JSON.stringify({name:values.name,kana:values.kana,phone:values.phone,gender:values.gender,initialInfo:{customerNo:values.customerNo,email:values.email,address:values.address,birthDate:values.birthDate,occupation:values.occupation}})});toast('初回登録情報を保存しました');await openCustomer(id)}catch(error){$('#basicInfoError').textContent=error.message;button.disabled=false}}}
  ...
  const topicBox=document.createElement('section');topicBox.className='topic-points';
  topicBox.innerHTML=`<div class="topic-points-heading"><h3>話題ポイント</h3>${d.canEdit?'<button type="button" class="ghost" id="editTopicPoints">話題を追加</button>':''}</div><ul id="topicPointsList">${topicPoints.map(point=>`<li>${esc(point)}</li>`).join('')||'<li class="muted">過去の施術から話題を蓄積します</li>'}</ul><div class="topic-editor hidden" id="topicEditor"><textarea rows="4" id="topicPointsInput" placeholder="話題を1行に1件ずつ入力してください"></textarea><div class="alert-editor-actions"><button type="button" class="ghost" id="cancelTopicPoints">キャンセル</button><button type="button" class="primary" id="saveTopicPoints">保存</button></div></div>`;
  preferenceBox.insertAdjacentElement('afterend',topicBox);
  const interestsBox=document.createElement('section');interestsBox.className='topic-points customer-interests';interestsBox.innerHTML=`<h3>関心ごと</h3><ul id="customerInterests">${(c.interests||[]).map(value=>`<li>${esc(value)}</li>`).join('')||'<li>登録なし</li>'}</ul>`;topicBox.insertAdjacentElement('afterend',interestsBox);
  const editTopicButton=$('#editTopicPoints'),topicEditor=$('#topicEditor'),topicList=$('#topicPointsList'),topicInput=$('#topicPointsInput');
  if(editTopicButton){topicInput.value=(c.manualTopicPoints||[]).join('\n');const toggleTopicEditor=editing=>{topicEditor.classList.toggle('hidden',!editing);topicList.classList.toggle('hidden',editing);if(editing)topicInput.focus()};editTopicButton.onclick=()=>toggleTopicEditor(true);$('#cancelTopicPoints').onclick=()=>toggleTopicEditor(false);$('#saveTopicPoints').onclick=async event=>{const button=event.currentTarget;button.disabled=true;try{const manualTopicPoints=topicInput.value.split(/\r?\n/).map(value=>value.trim()).filter(Boolean);await api(`/api/customers/${id}`,{method:'PUT',body:JSON.stringify({manualTopicPoints})});toast('話題ポイントを保存しました');await openCustomer(id)}catch(error){toast(error.message);button.disabled=false}}}
  const lastVisit=$('.profile .last-visit'),profileName=$('.profile > h2');
  if(lastVisit&&profileName)profileName.insertAdjacentElement('afterend',lastVisit);
  ...
  $('#backToCustomers').onclick=()=>show('dashboard');
    ...
    content.innerHTML=`<div class="card error">施術履歴を表示できませんでした。${esc(error.message)}<div style="margin-top:14px"><button type="button" class="ghost" id="retryCustomerHistory">再読み込み</button><button type="button" class="ghost" id="backFromCustomerError">ホームへ戻る</button></div></div>`;
    $('#retryCustomerHistory').onclick=()=>openCustomer(id);
    $('#backFromCustomerError').onclick=()=>show('dashboard');
    toast(error.message||'施術履歴を表示できませんでした');
  }
}
...
function setupScanPatientSelector(){
  const layout=$('.scan-layout');
  if(!layout||$('#scanCustomer'))return;
  const panel=document.createElement('section');
  panel.className='card scan-patient-selector';
  panel.innerHTML=`<label>お客様を選ぶ<select id="scanCustomer"><option value="">選択してください</option>${state.customers.map(customer=>`<option value="${customer.id}" ${state.selectedCustomerId===customer.id?'selected':''}>${esc(customer.name)}${customer.phone?`（${esc(customer.phone)}）`:''}</option>`).join('')}</select></label>`;
  layout.before(panel);
  const selector=$('#scanCustomer');
  const recordSelector=$('#recordCustomer');
  if(recordSelector&&state.selectedCustomerId)recordSelector.value=state.selectedCustomerId;
  selector.onchange=()=>{state.selectedCustomerId=selector.value;if(recordSelector)recordSelector.value=selector.value};
}
function bindScanSave(){setupScanPatientSelector();const b=$('#saveRecord');if(!b)return;b.onclick=async()=>{try{const values=Object.fromEntries($$('[data-field]').map(el=>[el.dataset.field,el.value]));const alerts=$$('#alertChips input:checked').map(x=>x.value);const images=imagesForRecord();const customerId=$('#scanCustomer')?.value||$('#recordCustomer')?.value||'';await api('/api/records',{method:'POST',body:JSON.stringify({customerId,visitDate:$('#recordDate').value,templateId:state.selectedTemplate.id,values,alerts,note:$('#recordNote').value,images})});state.scan=null;state.image='';state.images=[];state.selectedCustomerId='';state.partImages[state.workflowStage]='';toast('カルテ画像と部位写真を保存しました');show('dashboard')}catch(e){toast(e.message)}}}
async function renderAccounts(target=$('#content'),embedded=false){
  const accounts=await api('/api/accounts');
  target.innerHTML=`${embedded?'<div class="section-head"><h2>アカウント管理</h2></div>':''}<section class="card"><div class="section-head"><h2>施術者アカウントを作成</h2><span class="badge">${esc(state.user.tenant.name)}</span></div><form id="accountForm" class="account-form"><label>施術者名<input name="name" required placeholder="例：山田 花子"></label><label>アカウント名<input name="accountId" required minlength="3" pattern="[A-Za-z0-9._-]+" placeholder="例：yamada01"></label><label>初期パスワード<input name="password" type="password" required minlength="8" autocomplete="new-password"></label><button class="primary">アカウントを作成</button></form><p id="accountError" class="error"></p></section><div class="section-head"><h2>店舗アカウント</h2><span class="badge">${accounts.length}件</span></div><div class="account-grid">${accounts.map(account=>`<article class="card account-card"><div class="avatar">${esc(account.name[0]||'施')}</div><div><b>${esc(account.name)}</b><span class="account-id">${esc(account.accountId)}</span><small>${account.role==='owner'?'店舗管理者':'施術者'}</small></div>${account.protected?'<span class="protected-badge">管理者作成・削除不可</span>':`<button class="danger-btn account-delete" data-id="${esc(account.id)}" data-name="${esc(account.name)}">削除</button>`}</article>`).join('')||'<div class="card empty">アカウントがありません</div>'}</div>`;
  target.querySelector('#accountForm').onsubmit=async e=>{
    e.preventDefault();target.querySelector('#accountError').textContent='';
    const button=e.submitter;button.disabled=true;
    try{
      await api('/api/accounts',{method:'POST',body:JSON.stringify(Object.fromEntries(new FormData(e.target)))});
      toast('施術者アカウントを作成しました');renderAccounts(target,embedded);
    }catch(error){target.querySelector('#accountError').textContent=error.message;button.disabled=false}
  };
  target.querySelectorAll('.account-delete').forEach(button=>button.onclick=async()=>{
    if(!confirm(`${button.dataset.name} の施術者アカウントを削除します。\n\nこのアカウントはログインできなくなります。顧客・カルテデータは削除されません。削除しますか？`))return;
    button.disabled=true;
    try{await api(`/api/accounts/${encodeURIComponent(button.dataset.id)}`,{method:'DELETE'});toast('施術者アカウントを削除しました');renderAccounts(target,embedded)}catch(error){toast(error.message);button.disabled=false}
  });
}
